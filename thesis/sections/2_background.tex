...
After that in Section \ref{sec:lcl_problems:biregular}, we introduce an alternative definition that we will be using in this work.
...
The reason why we discuss about the former definition is that we want the reader to have a good introduction to LCL problems before we discuss about the latter definition.
...
\subsubsection{LCL problems in biregular graphs} \label{sec:lcl_problems:biregular}
