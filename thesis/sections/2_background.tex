...
\begin{figure}[H]
  ...
  In the Figure \ref{fig:distributed_graph_problems1:c} the colors are the color
  }
...
The node labeling in Figure \ref{fig:distributed_graph_problems1:b} is an independent set.
