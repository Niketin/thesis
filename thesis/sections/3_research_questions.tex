...
\end{researchquestion}
We present the theorem as Theorem \ref{} in Section \ref{} and we answer to Research question \ref{research_question:2} by proving the theorem. \todo{Add ref to Theorem and Section} %TODO
