...
\begin{figure}[H]
    ...
    \begin{tikzpicture}[]
        \node (1) [] {Theorem \ref{thm:lcl_unsolvability:2}};
        \node (2) [right = of 1] {Theorem \ref{thm:lcl_unsolvability:3}};
        \node (3) [below = of $(1)!0.5!(2)$] {Theorem \ref{thm:lcl_unsolvability:4}};
        \node (4) [below = of 3] {Theorem \ref{thm:lcl_unsolvability:5}};
...
\begin{theorem} \label{thm:lcl_unsolvability:2}
...
\begin{theorem} \label{thm:lcl_unsolvability:3}
...
% \caption{\todo{Illustration of k-lift using Theorem \ref{thm:lcl_unsolvability:3}}}
% \label{fig:duck2}
%\end{figure}
