...
One could automate the finding of positive or negative results, and the case of negative results is exactly one of our work's objectives.
We will focus on the automation in the distributed  computing in Section \ref{sec:prior_work:title_b}
